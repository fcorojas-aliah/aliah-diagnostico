...
// ─── INVITE LINKS (códigos estáticos en tabla invite_links de Supabase) ───
export const APP_URL = "https://aliah-diagnostico-production.up.railway.app";
...
// ─── ROLES ───
export const ROLES = {
  ceo:      { label: "CEO",                canSeeDashboard: true,  canSeePersonal: true,  canManageUsers: true,  canSeeAll: true },
  rrhh:     { label: "RRHH",               canSeeDashboard: true,  canSeePersonal: true,  canManageUsers: false, canSeeAll: true },
  director: { label: "DIRECTOR / MANAGER", canSeeDashboard: true,  canSeePersonal: false, canManageUsers: false, canSeeAll: false },
  usuario:  { label: "USUARIO",            canSeeDashboard: false, canSeePersonal: false, canManageUsers: false, canSeeAll: false },
};
